--模块化相邻加成示例
    ...
    VALUES 
--+1粮
    ('RUIVO_DISTRICT_C_AGRICULTURE_YIELD_FOOD_FROM_ADJACENT_WORKER', 'DISTRICT_C_AGRICULTURE', 
...
--军营：获得城市防御5%的生产力，相邻单位+1忠诚度+1生产力
    ('RUIVO_DISTRICT_ENCAMPMENT_YIELD_PRODUCTION_FROM_CITY_DEFENSE_STRENGTH', 'DISTRICT_ENCAMPMENT', 
    'SelfBonus', 'YIELD_PRODUCTION', 0.05, 
    'FROM_CITY_DEFENSE_STRENGTH', 'NONE', 1,
    1),
    ('RUIVO_DISTRICT_ENCAMPMENT_YIELD_PRODUCTION_FROM_ADJACENT_UNIT', 'DISTRICT_ENCAMPMENT', 
    'SelfBonus', 'YIELD_PRODUCTION', 1, 
...
--商业中心：每经营一条贸易路线，+1金币
    ('RUIVO_DISTRICT_COMMERCIAL_HUB_YIELD_GOLD_FROM_OUTGOING_ROUTES',                     'DISTRICT_COMMERCIAL_HUB',              'YIELD_GOLD', 1,          'FROM_OUTGOING_ROUTES',        1,                 'SelfBonus'),
--娱乐中心：本城每点溢出宜居度，+2金币
...
--水上乐园：本城每点溢出宜居度，+3金币
    ('RUIVO_DISTRICT_WATER_ENTERTAINMENT_COMPLEX_YIELD_GOLD_FROM_CITY_SURPLUS_AMENITIES', 'DISTRICT_WATER_ENTERTAINMENT_COMPLEX', 'YIELD_GOLD', 3,          'FROM_CITY_SURPLUS_AMENITIES', 1,                 'SelfBonus');
...
--学院：二环内每座山脉为自身+0.5大科点
    ...
    1),
--剧院：四环内每个市中心为自己+1文化
    ('RUIVO_DISTRICT_THEATER_YIELD_CULTURE_FROM_DISTRICT_CITY_CENTER', 'DISTRICT_THEATER', 
