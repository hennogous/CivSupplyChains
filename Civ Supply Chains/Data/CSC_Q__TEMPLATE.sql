...
BuildingModifiers
		...
		(	'BUILDING_FERRIS_WHEEL',					'MOD_CSC_BAKERS_FERRIS_GOLD_TO_PATISS_POP_USES_20_ATTACH'	),
		(	'BUILDING_FERRIS_WHEEL',					'MOD_CSC_BAKERS_FERRIS_GOLD_TO_PATISS_POP_USES_40_ATTACH'	),
...
RequirementSets
		...
		(	'REQSET_CSC_CITY_POPULATION_USES_MOD_5',				'REQUIREMENTSET_TEST_ANY'		),
		(	'REQSET_CSC_CITY_POPULATION_USES_MOD_10',				'REQUIREMENTSET_TEST_ANY'		),
		(	'REQSET_CSC_CITY_POPULATION_USES_MOD_20',				'REQUIREMENTSET_TEST_ANY'		),
		(	'REQSET_CSC_CITY_POPULATION_USES_MOD_40',				'REQUIREMENTSET_TEST_ANY'		),

		(	'REQSET_CSC_POPULATION_5_TO_9',							'REQUIREMENTSET_TEST_ALL'		),
		(	'REQSET_CSC_POPULATION_10_TO_14',						'REQUIREMENTSET_TEST_ALL'		),
		(	'REQSET_CSC_POPULATION_15_TO_19',						'REQUIREMENTSET_TEST_ALL'		),
		(	'REQSET_CSC_POPULATION_20_TO_24',						'REQUIREMENTSET_TEST_ALL'		),
		(	'REQSET_CSC_POPULATION_25_TO_29',						'REQUIREMENTSET_TEST_ALL'		),
		(	'REQSET_CSC_POPULATION_30_TO_34',						'REQUIREMENTSET_TEST_ALL'		),
		(	'REQSET_CSC_POPULATION_35_TO_39',						'REQUIREMENTSET_TEST_ALL'		),
		(	'REQSET_CSC_POPULATION_40_TO_44',						'REQUIREMENTSET_TEST_ALL'		),
		(	'REQSET_CSC_POPULATION_45_TO_49',						'REQUIREMENTSET_TEST_ALL'		),
		(	'REQSET_CSC_POPULATION_50_PLUS',						'REQUIREMENTSET_TEST_ALL'		),

RequirementSetRequirements

		(	'REQSET_CSC_CITY_POPULATION_USES_MOD_5',				'REQ_CSC_POPULATION_5_TO_9'						),
		(	'REQSET_CSC_CITY_POPULATION_USES_MOD_5',				'REQ_CSC_POPULATION_15_TO_19'					),
		(	'REQSET_CSC_CITY_POPULATION_USES_MOD_5',				'REQ_CSC_POPULATION_25_TO_29'					),
		(	'REQSET_CSC_CITY_POPULATION_USES_MOD_5',				'REQ_CSC_POPULATION_35_TO_39'					),
		(	'REQSET_CSC_CITY_POPULATION_USES_MOD_5',				'REQ_CSC_POPULATION_45_TO_49'					),

		(	'REQSET_CSC_CITY_POPULATION_USES_MOD_10',				'REQ_CSC_POPULATION_10_TO_14'					),
		(	'REQSET_CSC_CITY_POPULATION_USES_MOD_10',				'REQ_CSC_POPULATION_15_TO_19'					),
		(	'REQSET_CSC_CITY_POPULATION_USES_MOD_10',				'REQ_CSC_POPULATION_30_TO_34'					),
		(	'REQSET_CSC_CITY_POPULATION_USES_MOD_10',				'REQ_CSC_POPULATION_35_TO_39'					),
		(	'REQSET_CSC_CITY_POPULATION_USES_MOD_10',				'REQ_CSC_POPULATION_50_PLUS'					),

		(	'REQSET_CSC_CITY_POPULATION_USES_MOD_20',				'REQ_CSC_POPULATION_20_TO_24'					),
		(	'REQSET_CSC_CITY_POPULATION_USES_MOD_20',				'REQ_CSC_POPULATION_25_TO_29'					),
		(	'REQSET_CSC_CITY_POPULATION_USES_MOD_20',				'REQ_CSC_POPULATION_30_TO_34'					),
		(	'REQSET_CSC_CITY_POPULATION_USES_MOD_20',				'REQ_CSC_POPULATION_35_TO_39'					),

		(	'REQSET_CSC_CITY_POPULATION_USES_MOD_40',				'REQ_CSC_POPULATION_40_TO_44'					),
		(	'REQSET_CSC_CITY_POPULATION_USES_MOD_40',				'REQ_CSC_POPULATION_45_TO_49'					),
		(	'REQSET_CSC_CITY_POPULATION_USES_MOD_40',				'REQ_CSC_POPULATION_50_PLUS'					),

		(	'REQSET_CSC_POPULATION_5_TO_9',							'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_5'				),
		(	'REQSET_CSC_POPULATION_5_TO_9',							'REQ_CSC_CITY_POP_LESS_THAN_10'					),
		(	'REQSET_CSC_POPULATION_10_TO_14',						'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_10'				),
		(	'REQSET_CSC_POPULATION_10_TO_14',						'REQ_CSC_CITY_POP_LESS_THAN_15'					),
		(	'REQSET_CSC_POPULATION_15_TO_19',						'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_15'				),
		(	'REQSET_CSC_POPULATION_15_TO_19',						'REQ_CSC_CITY_POP_LESS_THAN_20'					),
		(	'REQSET_CSC_POPULATION_20_TO_24',						'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_20'				),
		(	'REQSET_CSC_POPULATION_20_TO_24',						'REQ_CSC_CITY_POP_LESS_THAN_25'					),
		(	'REQSET_CSC_POPULATION_25_TO_29',						'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_25'				),
		(	'REQSET_CSC_POPULATION_25_TO_29',						'REQ_CSC_CITY_POP_LESS_THAN_30'					),
		(	'REQSET_CSC_POPULATION_30_TO_34',						'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_30'				),
		(	'REQSET_CSC_POPULATION_30_TO_34',						'REQ_CSC_CITY_POP_LESS_THAN_35'					),
		(	'REQSET_CSC_POPULATION_35_TO_39',						'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_35'				),
		(	'REQSET_CSC_POPULATION_35_TO_39',						'REQ_CSC_CITY_POP_LESS_THAN_40'					),
		(	'REQSET_CSC_POPULATION_40_TO_44',						'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_40'				),
		(	'REQSET_CSC_POPULATION_40_TO_44',						'REQ_CSC_CITY_POP_LESS_THAN_45'					),
		(	'REQSET_CSC_POPULATION_45_TO_49',						'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_45'				),
		(	'REQSET_CSC_POPULATION_45_TO_49',						'REQ_CSC_CITY_POP_LESS_THAN_50'					),
		(	'REQSET_CSC_POPULATION_50_PLUS',						'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_50'				),

Requirements

		(	'REQ_CSC_CITY_POPULATION_USES_MOD_5',					'REQUIREMENT_REQUIREMENTSET_IS_MET',				0				),
		(	'REQ_CSC_CITY_POPULATION_USES_MOD_10',					'REQUIREMENT_REQUIREMENTSET_IS_MET',				0				),
		(	'REQ_CSC_CITY_POPULATION_USES_MOD_20',					'REQUIREMENT_REQUIREMENTSET_IS_MET',				0				),
		(	'REQ_CSC_CITY_POPULATION_USES_MOD_40',					'REQUIREMENT_REQUIREMENTSET_IS_MET',				0				),

		(	'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_5',						'REQUIREMENT_CITY_HAS_X_POPULATION',				0				),
		(	'REQ_CSC_CITY_POP_LESS_THAN_10',						'REQUIREMENT_CITY_HAS_X_POPULATION',				1				),
		(	'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_10',					'REQUIREMENT_CITY_HAS_X_POPULATION',				0				),
		(	'REQ_CSC_CITY_POP_LESS_THAN_15',						'REQUIREMENT_CITY_HAS_X_POPULATION',				1				),
		(	'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_15',					'REQUIREMENT_CITY_HAS_X_POPULATION',				0				),
		(	'REQ_CSC_CITY_POP_LESS_THAN_20',						'REQUIREMENT_CITY_HAS_X_POPULATION',				1				),
		(	'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_20',					'REQUIREMENT_CITY_HAS_X_POPULATION',				0				),
		(	'REQ_CSC_CITY_POP_LESS_THAN_25',						'REQUIREMENT_CITY_HAS_X_POPULATION',				1				),
		(	'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_25',					'REQUIREMENT_CITY_HAS_X_POPULATION',				0				),
		(	'REQ_CSC_CITY_POP_LESS_THAN_30',						'REQUIREMENT_CITY_HAS_X_POPULATION',				1				),
		(	'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_30',					'REQUIREMENT_CITY_HAS_X_POPULATION',				0				),
		(	'REQ_CSC_CITY_POP_LESS_THAN_35',						'REQUIREMENT_CITY_HAS_X_POPULATION',				1				),
		(	'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_35',					'REQUIREMENT_CITY_HAS_X_POPULATION',				0				),
		(	'REQ_CSC_CITY_POP_LESS_THAN_40',						'REQUIREMENT_CITY_HAS_X_POPULATION',				1				),
		(	'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_40',					'REQUIREMENT_CITY_HAS_X_POPULATION',				0				),
		(	'REQ_CSC_CITY_POP_LESS_THAN_45',						'REQUIREMENT_CITY_HAS_X_POPULATION',				1				),
		(	'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_45',					'REQUIREMENT_CITY_HAS_X_POPULATION',				0				),
		(	'REQ_CSC_CITY_POP_LESS_THAN_50',						'REQUIREMENT_CITY_HAS_X_POPULATION',				1				),
		(	'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_50',					'REQUIREMENT_CITY_HAS_X_POPULATION',				0				),

		(	'REQ_CSC_POPULATION_5_TO_9',							'REQUIREMENT_REQUIREMENTSET_IS_MET',				0				),
		(	'REQ_CSC_POPULATION_10_TO_14',							'REQUIREMENT_REQUIREMENTSET_IS_MET',				0				),
		(	'REQ_CSC_POPULATION_15_TO_19',							'REQUIREMENT_REQUIREMENTSET_IS_MET',				0				),
		(	'REQ_CSC_POPULATION_20_TO_24',							'REQUIREMENT_REQUIREMENTSET_IS_MET',				0				),
		(	'REQ_CSC_POPULATION_25_TO_29',							'REQUIREMENT_REQUIREMENTSET_IS_MET',				0				),
		(	'REQ_CSC_POPULATION_30_TO_34',							'REQUIREMENT_REQUIREMENTSET_IS_MET',				0				),
		(	'REQ_CSC_POPULATION_35_TO_39',							'REQUIREMENT_REQUIREMENTSET_IS_MET',				0				),
		(	'REQ_CSC_POPULATION_40_TO_44',							'REQUIREMENT_REQUIREMENTSET_IS_MET',				0				),
		(	'REQ_CSC_POPULATION_45_TO_49',							'REQUIREMENT_REQUIREMENTSET_IS_MET',				0				),
		(	'REQ_CSC_POPULATION_50_PLUS',							'REQUIREMENT_REQUIREMENTSET_IS_MET',				0				),

RequirementArguments

		(	'REQ_CSC_CITY_POPULATION_USES_MOD_5',					'RequirementSetId',				'REQSET_CSC_CITY_POPULATION_USES_MOD_5'			),
		(	'REQ_CSC_CITY_POPULATION_USES_MOD_10',					'RequirementSetId',				'REQSET_CSC_CITY_POPULATION_USES_MOD_10'		),
		(	'REQ_CSC_CITY_POPULATION_USES_MOD_20',					'RequirementSetId',				'REQSET_CSC_CITY_POPULATION_USES_MOD_20'		),
		(	'REQ_CSC_CITY_POPULATION_USES_MOD_40',					'RequirementSetId',				'REQSET_CSC_CITY_POPULATION_USES_MOD_40'		),

		(	'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_5',						'Amount',						5												),
		(	'REQ_CSC_CITY_POP_LESS_THAN_10',						'Amount',						10												),
		(	'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_10',					'Amount',						10												),
		(	'REQ_CSC_CITY_POP_LESS_THAN_15',						'Amount',						15												),
		(	'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_15',					'Amount',						15												),
		(	'REQ_CSC_CITY_POP_LESS_THAN_20',						'Amount',						20												),
		(	'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_20',					'Amount',						20												),
		(	'REQ_CSC_CITY_POP_LESS_THAN_25',						'Amount',						25												),
		(	'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_25',					'Amount',						25												),
		(	'REQ_CSC_CITY_POP_LESS_THAN_30',						'Amount',						30												),
		(	'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_30',					'Amount',						30												),
		(	'REQ_CSC_CITY_POP_LESS_THAN_35',						'Amount',						35												),
		(	'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_35',					'Amount',						35												),
		(	'REQ_CSC_CITY_POP_LESS_THAN_40',						'Amount',						40												),
		(	'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_40',					'Amount',						40												),
		(	'REQ_CSC_CITY_POP_LESS_THAN_45',						'Amount',						45												),
		(	'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_45',					'Amount',						45												),
		(	'REQ_CSC_CITY_POP_LESS_THAN_50',						'Amount',						50												),
		(	'REQ_CSC_CITY_POP_EQ_OR_GR_THAN_50',					'Amount',						50												),

		(	'REQ_CSC_POPULATION_5_TO_9',							'RequirementSetId',				'REQSET_CSC_POPULATION_5_TO_9'					),
		(	'REQ_CSC_POPULATION_10_TO_14',							'RequirementSetId',				'REQSET_CSC_POPULATION_10_TO_14'				),
		(	'REQ_CSC_POPULATION_15_TO_19',							'RequirementSetId',				'REQSET_CSC_POPULATION_15_TO_19'				),
		(	'REQ_CSC_POPULATION_20_TO_24',							'RequirementSetId',				'REQSET_CSC_POPULATION_20_TO_24'				),
		(	'REQ_CSC_POPULATION_25_TO_29',							'RequirementSetId',				'REQSET_CSC_POPULATION_25_TO_29'				),
		(	'REQ_CSC_POPULATION_30_TO_34',							'RequirementSetId',				'REQSET_CSC_POPULATION_30_TO_34'				),
		(	'REQ_CSC_POPULATION_35_TO_39',							'RequirementSetId',				'REQSET_CSC_POPULATION_35_TO_39'				),
		(	'REQ_CSC_POPULATION_40_TO_44',							'RequirementSetId',				'REQSET_CSC_POPULATION_40_TO_44'				),
		(	'REQ_CSC_POPULATION_45_TO_49',							'RequirementSetId',				'REQSET_CSC_POPULATION_45_TO_49'				),
		(	'REQ_CSC_POPULATION_50_PLUS',							'RequirementSetId',				'REQSET_CSC_POPULATION_50_PLUS'					),

*/

/*		(
		/*  BuildingType, */		'BUILDING_CSC_BAKERS_STAGE_3_SPECIALIST_SUGUBA',
		/*  Name, */				'LOC_BUILDING_CSC_BAKERS_STAGE_3_SPECIALIST_NAME',
		/*  Description, */			'LOC_BUILDING_CSC_BAKERS_STAGE_3_SPECIALIST_DESCRIPTION',
		/*  PrereqTech, */			NULL,
		/*  PrereqCivic, */			NULL,
		/*  Cost, */				0,
		/*  PrereqDistrict, */		'DISTRICT_SUGUBA',
		/*  PurchaseYield, */		NULL,
		/*  Maintenance, */			0,
		/*	CitizenSlots */			1,
		/*  Entertainment */		0,
...
INSERT OR IGNORE INTO District_Adjacencies
		(	DistrictType,						YieldChangeId		)
SELECT		CivUniqueDistrictType,				'CSC_BAKERS_FOOD_TO_ADJACENT_DISTRICT'
FROM		DistrictReplaces
WHERE		ReplacesDistrictType IN ('DISTRICT_COMMERCIAL_HUB');

-- Culture adjacency to replacers
INSERT OR IGNORE INTO District_Adjacencies (
    DistrictType,
    YieldChangeId
)
SELECT
    ...
    'CSC_BAKERS_CULTURE_TO_ADJACENT_DISTRICT'
FROM DistrictReplaces
...
SELECT
    'DISTRICT_CSC_BAKERS_QUARTER',
    'CSC_' || CivUniqueDistrictType || '_GOLD_TO_BAKERS'
FROM DistrictReplaces
WHERE ReplacesDistrictType IN ('DISTRICT_COMMERCIAL_HUB')
UNION ALL
SELECT
    ...
    'CSC_' || CivUniqueDistrictType || '_GOLD_TO_BAKERS'
FROM DistrictReplaces
WHERE ReplacesDistrictType IN ('DISTRICT_ENTERTAINMENT_COMPLEX')
UNION ALL
SELECT
    'DISTRICT_CSC_BAKERS_QUARTER',
    'CSC_' || CivUniqueDistrictType || '_GOLD_TO_BAKERS'
FROM DistrictReplaces
WHERE ReplacesDistrictType IN ('DISTRICT_WATER_ENTERTAINMENT_COMPLEX');
*/
...
--  Gold adjacency from Entertainment Complex replacers
INSERT OR IGNORE INTO Adjacency_YieldChanges
		(	ID,
			Description,
			YieldType,
...
FROM 		Districts
WHERE 		DistrictType IN (SELECT CivUniqueDistrictType FROM DistrictReplaces WHERE ReplacesDistrictType='DISTRICT_ENTERTAINMENT_COMPLEX');

--  Gold adjacency from Water Park replacers
INSERT OR IGNORE INTO Adjacency_YieldChanges
		(	ID,
			Description,
			YieldType,
...
FROM 		Districts
WHERE 		DistrictType IN (SELECT CivUniqueDistrictType FROM DistrictReplaces WHERE ReplacesDistrictType='DISTRICT_WATER_ENTERTAINMENT_COMPLEX');

*/

		(
		/*  BuildingType, */		'BUILDING_CSC_BAKERS_STAGE_4_SPECIALIST_STREET',
		/*  Name, */				'LOC_BUILDING_CSC_BAKERS_STAGE_4_SPECIALIST_NAME',
		/*  Description, */			'LOC_BUILDING_CSC_BAKERS_STAGE_4_SPECIALIST_DESCRIPTION',
		/*  PrereqTech, */			NULL,
		/*  PrereqCivic, */			NULL,
		/*  Cost, */				0,
		/*  PrereqDistrict, */		'DISTRICT_STREET_CARNIVAL',
		/*  PurchaseYield, */		NULL,
		/*  Maintenance, */			0,
		/*	CitizenSlots */			1,
		/*  Entertainment */		0,
		...
		(
		/*  BuildingType, */		'BUILDING_CSC_BAKERS_STAGE_4_SPECIALIST_HIPPO',
		/*  Name, */				'LOC_BUILDING_CSC_BAKERS_STAGE_4_SPECIALIST_NAME',
		/*  Description, */			'LOC_BUILDING_CSC_BAKERS_STAGE_4_SPECIALIST_DESCRIPTION',
		/*  PrereqTech, */			NULL,
		/*  PrereqCivic, */			NULL,
		/*  Cost, */				0,
		/*  PrereqDistrict, */		'DISTRICT_HIPPODROME',
		/*  PurchaseYield, */		NULL,
		/*  Maintenance, */			0,
		/*	CitizenSlots */			1,
		/*  Entertainment */		0,
		...
		,
		(
		/*  BuildingType, */		'BUILDING_CSC_BAKERS_STAGE_4_SPECIALIST_COPA',
		/*  Name, */				'LOC_BUILDING_CSC_BAKERS_STAGE_4_SPECIALIST_NAME',
		/*  Description, */			'LOC_BUILDING_CSC_BAKERS_STAGE_4_SPECIALIST_DESCRIPTION',
		/*  PrereqTech, */			NULL,
		/*  PrereqCivic, */			NULL,
		/*  Cost, */				0,
		/*  PrereqDistrict, */		'DISTRICT_WATER_STREET_CARNIVAL',
		/*  PurchaseYield, */		NULL,
		/*  Maintenance, */			0,
		/*	CitizenSlots */			1,
		/*  Entertainment */		0,
