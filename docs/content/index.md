...
In this mod, I'm trying to create the version of Civ that I've always wanted to play: all of the just-one-more-turn feeling of Civ, expanded with a toolbox for telling many more small stories. A local forest turning into ships for exploring the globe, and even string instruments in the Bolshoi Theater. Or a cotton plantation and some <img src='https://static.wikia.nocookie.net/civilization/images/b/bc/Civ6Gold.png/revision/latest/scale-to-width-down/18?cb=20200501084519' width='18' style='vertical-align:middle'/> Gold thread driving a thriving textiles industry leading to some very well-dressed and influential diplomats!
