...
Benefits to specialists or Patricians from government types and policies
...
* +1 {{production}} Production and {{gold}} Gold per specialist in supply chain districts
* +1 {{gold}} Gold on tiles adjacent to Patricians
* Networks: +1 Influence points from each Patrician
* +1 {{gold}} Gold from all foreign commissioned specialty goods
* Recycled materials
...
E.g. +1 {{faith}} Faith to Bakers' Quarter specialty materials

## Great People

Add new ones, with effects that boost their Quarters
...
Enhance existing city projects in cities with Quarters
