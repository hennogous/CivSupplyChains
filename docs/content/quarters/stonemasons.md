...
* +1 {{production}} Production to any adjacent Tier 1 Government Building, and receive +1 {{gold}} Gold in return
   * With Defensive Tactics, each Stonecutter adjacent to a Tier 1 Government Building provides +10% {{production}} Production to the construction of Ancient, Medieval and Renaissance Walls in cities within 6 tiles
* +1 {{gold}} Gold from the local Stonemason and Sculptor's Studio
* +1 {{production}} Production bonus to trade routes to the city, and +1 {{gold}} Gold in return from international routes
...
* +2 {{production}} Production, with a -2 {{gold}} Gold maintenance cost
* +0.1 {{production}} Production and +0.1 {{gold}} Gold per Citizen to the city for each adjacent Market
* +0.1 {{production}} Production and +0.1 {{faith}} Faith per Citizen to the city for each adjacent Renaissance (or earlier) Wonder
   * With Reformed Church, +20% {{production}} Production to the construction of any Renaissance Era (or earlier) Wonder for each adjacent Stonemason
* +1 Citizen slot, and +2 {{production}} Production and +1 {{gold}} Gold to Citizens in the Quarter
* +1 {{production}} Production bonus to all trade routes to the city, and +1 {{gold}} Gold in return from international routes
* +1 {{amenity}} Amenity
